  ...
  <div>
    <x-body-content>
      <div class="p-6 ">
        ...
        <section class="italic p-12">
          O Instituto Horus é uma associação civil sem fins lucrativos, que acredita na transformação das pessoas a
          partir de propostas inovadoras. Criado em 11 de abril de 2010 tem como seu principal objetivo promover o
          aprimoramento humano incentivando a cultura e a arte, o desenvolvimento sustentável e a defesa, preservação e
          conservação do meio ambiente e do esporte.
        </section>
